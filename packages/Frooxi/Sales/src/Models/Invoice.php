...
use Frooxi\Sales\Contracts\Invoice as InvoiceContract;
use Frooxi\Sales\Database\Factories\InvoiceFactory;
use Frooxi\Sales\Traits\InvoiceReminder;
use Frooxi\Sales\Traits\PaymentTerm;

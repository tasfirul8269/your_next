...
namespace Frooxi\Checkout;

use Frooxi\Checkout\Contracts\CartAddress as CartAddressContract;
use Frooxi\Checkout\Exceptions\BillingAddressNotFoundException;
use Frooxi\Checkout\Models\CartAddress;
use Frooxi\Checkout\Models\CartPayment;
use Frooxi\Checkout\Repositories\CartAddressRepository;
use Frooxi\Checkout\Repositories\CartItemRepository;
use Frooxi\Checkout\Repositories\CartRepository;
use Frooxi\Customer\Contracts\Customer as CustomerContract;
use Frooxi\Customer\Contracts\Wishlist as WishlistContract;
    ...
    public function validateItems(): bool
    {
        ...
        foreach ($this->cart->items as $key => $item) {
            ...
            if ($validationResult->isItemInactive()) {
                ...
                // }
                $itemBasePrice = $item->base_price; // REMOVED: Tax package deleted
    ...
    public function calculateItemsTax(): void
    {
        ...
        foreach ($this->cart->items as $key => $item) {
            ...
            */
            ...
            // REMOVED: Tax package deleted - no tax calculation
            $address = null;

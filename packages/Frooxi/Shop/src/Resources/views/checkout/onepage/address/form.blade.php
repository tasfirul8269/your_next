    ...
    >
        <div class="mt-2 max-md:mt-3">
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('frooxi.shop.checkout.onepage.address.form.first_name.after') !!}
                ...
                {!! view_render_event('frooxi.shop.checkout.onepage.address.form.last_name.after') !!}
            </div>
            ...
            {!! view_render_event('frooxi.shop.checkout.onepage.address.form.email.after') !!}
            ...
            {!! view_render_event('frooxi.shop.checkout.onepage.address.form.address.after') !!}
            ...
            {!! view_render_event('frooxi.shop.checkout.onepage.address.form.city.after') !!}

            <!-- Mobile Number -->
            <x-shop::form.control-group>
                <x-shop::form.control-group.label class="required !mt-0">
                    @lang('shop::app.checkout.onepage.address.mobile-number')
                </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group.control
                    ...
                    :label="trans('shop::app.checkout.onepage.address.mobile-number')"
                    :placeholder="trans('shop::app.checkout.onepage.address.mobile-number')"
                />

                <x-shop::form.control-group.error ::name="controlName + '.phone'" />
            </x-shop::form.control-group>

            {!! view_render_event('frooxi.shop.checkout.onepage.address.form.phone.after') !!}
        </div>
    </script>

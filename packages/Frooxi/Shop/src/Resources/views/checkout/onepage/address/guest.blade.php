{!! view_render_event('frooxi.shop.checkout.onepage.address.guest.before') !!}
...
{!! view_render_event('frooxi.shop.checkout.onepage.address.guest.after') !!}
    ...
    >
        ...
        >
            <form @submit="handleSubmit($event, addAddress)">
                ...
                <div class="mb-4">
                    {!! view_render_event('frooxi.shop.checkout.onepage.address.guest.billing.before') !!}
                    ...
                    {!! view_render_event('frooxi.shop.checkout.onepage.address.guest.billing.after') !!}
                </div>
                ...
                <template v-if="cart.have_stockable_items">
                    ...
                    >
                        {!! view_render_event('frooxi.shop.checkout.onepage.address.guest.shipping.before') !!}
                        ...
                        {!! view_render_event('frooxi.shop.checkout.onepage.address.guest.shipping.after') !!}
                    </div>
                </template>
                ...
                <div class="mt-4 flex justify-end">
                    <x-shop::button
                        class="primary-button rounded-[5px] bg-[#e30612] px-8 py-3 text-sm font-medium text-white max-md:w-full max-md:max-w-full max-sm:py-2"

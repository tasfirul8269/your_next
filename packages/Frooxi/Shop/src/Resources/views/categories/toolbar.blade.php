{!! view_render_event('frooxi.shop.categories.view.toolbar.before') !!}

<v-toolbar @filter-applied='setFilters("toolbar", $event)'></v-toolbar>

{!! view_render_event('frooxi.shop.categories.view.toolbar.after') !!}

@inject('toolbar' , 'Frooxi\Product\Helpers\Toolbar')
    ...
    >
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                {!! view_render_event('frooxi.shop.categories.toolbar.filter.before') !!}
                ...
                {!! view_render_event('frooxi.shop.categories.toolbar.filter.after') !!}

                {!! view_render_event('frooxi.shop.categories.toolbar.pagination.before') !!}
                ...
                {!! view_render_event('frooxi.shop.categories.toolbar.pagination.after') !!}
            </div>

...
{!! view_render_event('frooxi.shop.products.view.reviews.after', ['product' => $product]) !!}

<v-product-reviews>
    <div class="{{ $reviewContainerClasses }}">
...
@pushOnce('scripts')
    ...
    >
        <div class="{{ $reviewTemplateClasses }}">
            ...
            >
                ...
                >
                    <!-- Review Form -->
                    <form
                        class="{{ $reviewFormClasses }}"
                        @submit="handleSubmit($event, store)"
                        enctype="multipart/form-data"
                    >
                        <div class="{{ $reviewMediaColumnClasses }}">
            ...
            <div v-else>
                ...
                <template v-else>
                    <template v-if="reviews.length">
                        ...
                        <div class="{{ $reviewLayoutClasses }}">
                            <!-- Left Section -->
                            <div class="{{ $reviewSummaryClasses }}">
                                ...
                                <div class="{{ $reviewRatingsClasses }}">
                                    @for ($i = 5; $i >= 1; $i--)

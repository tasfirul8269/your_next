{!! view_render_event('frooxi.shop.layout.features.before') !!}

<!--
    The ThemeCustomizationRepository repository is injected directly here because there is no way
    to retrieve it from the view composer, as this is an anonymous component.
-->
@inject('themeCustomizationRepository', 'Frooxi\Theme\Repositories\ThemeCustomizationRepository')
...
{!! view_render_event('frooxi.shop.layout.features.after') !!}
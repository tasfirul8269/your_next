        ...
        >
            <div>
                <x-shop::form :action="route('shop.customers.account.addresses.store')">
                    ...
                    {!! view_render_event('frooxi.shop.customers.account.addresses.create_form_controls.first_name.after') !!}
                    ...
                    {!! view_render_event('frooxi.shop.customers.account.addresses.create_form_controls.last_name.after') !!}
                    ...
                    {!! view_render_event('frooxi.shop.customers.account.addresses.create_form_controls.phone.after') !!}
                    ...
                    {!! view_render_event('frooxi.shop.customers.account.addresses.create_form_controls.after') !!}
                </x-shop::form>
                {!! view_render_event('frooxi.shop.customers.account.address.create.after') !!}
            </div>
        </script>

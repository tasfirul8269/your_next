...
use Frooxi\Shop\Http\Controllers\API\AddressController;
use Frooxi\Shop\Http\Controllers\API\CartController;
use Frooxi\Shop\Http\Controllers\API\CategoryController;
use Frooxi\Shop\Http\Controllers\API\CoreController;
use Frooxi\Shop\Http\Controllers\API\CustomerController;
use Frooxi\Shop\Http\Controllers\API\HeroSlideController;
use Frooxi\Shop\Http\Controllers\API\OnepageController;
use Frooxi\Shop\Http\Controllers\API\ProductController;
use Frooxi\Shop\Http\Controllers\API\ReviewController;
use Frooxi\Shop\Http\Controllers\API\WishlistController;
use Illuminate\Support\Facades\Route;

Route::group(['prefix' => 'api'], function () {
    Route::controller(HeroSlideController::class)->group(function () {
        Route::get('hero-slides', 'index')->name('shop.api.hero_slides.index');
    });
    ...
    Route::controller(CategoryController::class)->prefix('categories')->group(function () {
        ...
        Route::get('price-range/{id?}', 'getProductPriceRange')->name('shop.api.categories.price_range');
    });

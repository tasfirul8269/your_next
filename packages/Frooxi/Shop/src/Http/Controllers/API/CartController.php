...
// REMOVED: CartRule package deleted
// use Frooxi\CartRule\Repositories\CartRuleCouponRepository;
...
class CartController extends APIController
{
     ...
     * REMOVED: CartRule package deleted - coupon functionality disabled
     */
    public function storeCoupon()
    {
        return (new JsonResource([
            'data' => null,
            'message' => 'Coupon functionality is disabled.',

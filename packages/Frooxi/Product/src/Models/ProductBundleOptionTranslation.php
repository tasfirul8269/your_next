...
use Frooxi\Product\Contracts\ProductBundleOptionTranslation as ProductBundleOptionTranslationContract;
use Frooxi\Product\Database\Factories\ProductBundleOptionTranslationFactory;

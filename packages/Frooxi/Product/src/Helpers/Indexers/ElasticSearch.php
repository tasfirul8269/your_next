...
namespace Frooxi\Product\Helpers\Indexers;
...
use Frooxi\Core\Contracts\Locale;
use Frooxi\Core\Facades\ElasticSearch as ElasticSearchClient;
use Frooxi\Core\Repositories\ChannelRepository;
use Frooxi\Customer\Repositories\CustomerGroupRepository;
use Frooxi\Product\Contracts\ProductAttributeValue;
...
class ElasticSearch extends AbstractIndexer
{
     ...
     * Product instance.
     *
     * @var \Frooxi\Product\Contracts\Product
     */
    protected $product;

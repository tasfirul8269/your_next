...
use Frooxi\Product\Helpers\Indexers\Price\Simple as SimpleIndexer;
...
use Frooxi\Product\Repositories\ProductCustomizableOptionPriceRepository;
...
{
    /**
     * Skip attributes for simple product type.
     *
     * @var array
     */
    protected $skipAttributes = ['color', 'size'];

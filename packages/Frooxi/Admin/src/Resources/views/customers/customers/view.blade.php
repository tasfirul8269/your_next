<x-admin::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('frooxi.admin.customers.customers.view.filters.before') !!}
            ...
            <div class="mt-5 flex flex-wrap items-center gap-x-2 gap-y-2">
                ...
                @if (bouncer()->hasPermission('sales.orders.create'))
                    <div
                        class="inline-flex w-full max-w-max cursor-pointer items-center justify-between gap-x-2 rounded-lg border border-gray-100 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50"
                ...
                <a
                    ...
                    target="_blank"
                >
                    <span class="icon-exit text-xl"></span>
                ...
                @if (bouncer()->hasPermission('customers.customers.delete'))
                    <div
                        class="inline-flex w-full max-w-max cursor-pointer items-center justify-between gap-x-2 rounded-lg border border-red-100 bg-red-50 px-3 py-2 text-sm font-medium text-red-600 shadow-sm transition-all hover:bg-red-100"
                        @click="$emitter.emit('open-confirm-modal', {
            ...
            {!! view_render_event('frooxi.admin.customers.customers.view.filters.after') !!}

            <!-- Content -->
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <!-- Left Component -->
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    {!! view_render_event('frooxi.admin.customers.customers.view.card.orders.before') !!}

                    @include('admin::customers.customers.view.orders')

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.orders.after') !!}

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.invoices.before') !!}

                    @include('admin::customers.customers.view.invoices')

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.invoices.after') !!}

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.reviews.before') !!}

                    @include('admin::customers.customers.view.reviews')

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.reviews.after') !!}

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.notes.before') !!}

                    @include('admin::customers.customers.view.notes')

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.notes.after') !!}
                </div>

                <!-- Right Component -->
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">

                    {!! view_render_event('frooxi.admin.customers.customers.view.card.accordion.customer.before') !!}

                    <!-- Information -->
                    {!! view_render_event('frooxi.admin.customers.customers.view.card.accordion.customer.after') !!}
                        ...
                        <x-admin::accordion>
                            <x-slot:header>
                                <div class="flex w-full">
                                    <p class="w-full p-2.5 text-base font-semibold text-gray-900">
                            ...
                            <x-slot:content>
                                <div class="grid gap-y-2.5">
                                    <p
                                        class="break-all text-xl font-semibold text-gray-900"
                                        v-text="`${customer.first_name} ${customer.last_name}`"
                                    >
                                    </p>
                    ...
                    {!! view_render_event('frooxi.admin.customers.customers.view.card.accordion.address.before') !!}
                            ...
                            <x-slot:content>
                                ...
                                <template v-else>
                                    ...
                                    <div class="flex items-center gap-5 py-2.5">
                                        <img
                                            src="{{ frooxi_asset('images/settings/address.svg') }}"
                    ...
                    {!! view_render_event('frooxi.admin.customers.customers.view.card.accordion.address.after') !!}
                </div>
            </div>
        </script>

@if ($product->getTypeInstance()->isCustomizable())
    ...
    {!! view_render_event('frooxi.admin.catalog.product.edit.form.types.simple.customizable-options.before', ['product' => $product]) !!}

    <v-customizable-options :errors="errors"></v-customizable-options>

    {!! view_render_event('frooxi.admin.catalog.product.edit.form.types.simple.customizable-options.after', ['product' => $product]) !!}
        ...
        >
            <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
                ...
                >
                    <!-- Placeholder Image -->
                    <img
                        src="{{ frooxi_asset('images/icon-options.svg') }}"

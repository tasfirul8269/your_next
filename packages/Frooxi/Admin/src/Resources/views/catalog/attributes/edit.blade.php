<x-admin::layouts>
    ...
    {!! view_render_event('frooxi.admin.catalog.attributes.edit.before', ['attribute' => $attribute]) !!}
    ...
    {!! view_render_event('frooxi.admin.catalog.attributes.edit.after', ['attribute' => $attribute]) !!}
        ...
        >
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 overflow-auto max-xl:flex-auto">
                    ...
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.label.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.label.after', ['attribute' => $attribute]) !!}
                                                ...
                                                >
                                                    ...
                                                    <x-admin::table.td v-if="showSwatch && (swatchType == 'color' || swatchType == 'image')">
                                                        ...
                                                        <div v-if="swatchType == 'image'">
                                                            <img
                                                                :src="element.swatch_value_url || '{{ frooxi_asset('images/product-placeholders/front.svg') }}'"
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.general.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.general.after', ['attribute' => $attribute]) !!}

                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.validations.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.validations.after', ['attribute' => $attribute]) !!}

                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.configuration.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('frooxi.admin.catalog.attributes.edit.card.accordion.configuration.configuration.after', ['attribute' => $attribute]) !!}
                </div>
            </div>

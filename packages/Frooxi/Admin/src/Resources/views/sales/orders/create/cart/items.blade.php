{!! view_render_event('frooxi.admin.sales.order.create.cart.items.before') !!}
...
{!! view_render_event('frooxi.admin.sales.order.create.cart.items.after') !!}
    ...
    >
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            ...
            <div
                ...
                v-else
            >
                <img src="{{ frooxi_asset('images/icon-add-product.svg') }}" class="h-20 w-20 dark:mix-blend-exclusion dark:invert">

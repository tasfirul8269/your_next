    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <!-- Left Component -->
                {!! view_render_event('frooxi.admin.sales.order.create.left_component.before') !!}
                ...
                {!! view_render_event('frooxi.admin.sales.order.create.left_component.after') !!}

                <!-- Right Component -->
                {!! view_render_event('frooxi.admin.sales.order.right_component.before') !!}
                ...
                {!! view_render_event('frooxi.admin.sales.order.create.right_component.after') !!}
            </div>
        </script>

...
use Carbon\Carbon;
use Frooxi\Core\Concerns\CurrencyFormatter;
...
use Frooxi\Core\Repositories\CountryRepository;
use Frooxi\Core\Repositories\CountryStateRepository;
...
// REMOVED: Tax package on hold
// use Frooxi\Tax\Repositories\TaxCategoryRepository;
...
class Core
{
    ...
    /**
     * Get the version number of the Frooxi.
     *
     * @return string
     */
    public function version()
    {
        return static::YOURNEXT_VERSION;
    }
     ...
     *
     * @return \Frooxi\Customer\Contract\CustomerGroup
     */

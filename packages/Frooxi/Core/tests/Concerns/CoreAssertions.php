...
namespace Frooxi\Core\Tests\Concerns;

use Frooxi\CartRule\Contracts\CartRule;
use Frooxi\CartRule\Contracts\CartRuleCoupon;
use Frooxi\CatalogRule\Contracts\CatalogRule;
use Frooxi\Checkout\Contracts\Cart;
use Frooxi\Checkout\Contracts\CartItem;
use Frooxi\Checkout\Contracts\CartPayment;
use Frooxi\Checkout\Contracts\CartShippingRate;
use Frooxi\Sales\Contracts\InvoiceItem;
use Frooxi\Sales\Contracts\OrderItem;
use Frooxi\Sales\Contracts\OrderPayment;
